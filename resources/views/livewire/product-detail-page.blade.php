          ...
          <div class="lg:pl-20">
            <div class="mb-8 [&>ul]:list-disc [&>ul]:ml-4]">
              ...
              <p class="inline-block mb-6 text-4xl font-bold text-gray-700 dark:text-gray-400 ">
                <span>{{ Number::currency($product->price, 'PLN') }}</span>
                <span class="text-base font-normal text-gray-500 line-through dark:text-gray-400">{{ Number::currency($product->price, 'PLN') }}</span>
              </p>
